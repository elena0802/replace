...
export default function PaymentSuccessResult({
  ...
  if (status === "checking") {
    return (
      <section className="mx-auto max-w-2xl rounded-xl border border-default bg-surface p-7 text-center shadow-card sm:p-9">
        <p className="text-lg font-semibold text-link">결제 승인 확인 중</p>
  ...
  if (status === "paid") {
    return (
      <section className="mx-auto max-w-2xl rounded-xl border border-brand-muted/70 bg-surface p-7 text-center shadow-floating sm:p-9">
        <p className="text-lg font-semibold text-link">결제 완료</p>
        <h1 className="mt-3 text-3xl font-semibold tracking-normal text-ink">
          Premium이 활성화되었어요
        </h1>
        <div className="mt-6 rounded-2xl bg-page px-5 py-4 text-base leading-7 text-stone">
  ...
  return (
    <section className="mx-auto max-w-2xl rounded-xl border border-danger-border bg-surface p-7 text-center shadow-card sm:p-9">
      <p className="text-lg font-semibold text-danger">승인 확인 실패</p>
      <h1 className="mt-3 text-3xl font-semibold tracking-normal text-ink">
