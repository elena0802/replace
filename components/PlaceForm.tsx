...
import AIRecordHelper from "@/components/AIRecordHelper";
...
export default function PlaceForm({
  ...
  function handleApplyRecordSuggestion(suggestion: string) {
    updateValue("memory", suggestion);
    window.setTimeout(() => {
    ...
    >
      ...
      <section className="space-y-4 border-t border-[#EFEAE2] pt-5">
        ...
        <AIRecordHelper
          ...
          memo={values.memory}
          onApply={handleApplyRecordSuggestion}
